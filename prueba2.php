		...
		<div class="col-10" id="form1">
			...
			<div class="col-11 formcontainer" id="">
				...
				<form class="incform" action="" method="post">
				    ...
				    <select value="" name="selectflight" class="input1" id="sflight">
	                    	<option value="0" class="tabd" ></option>
	                <?php    	
...
if (isset($_POST['search'])) 
{
        $errorp = ""; // Variable To Store Error Message 
            ...
            if ($dateto=="" && $date=="" && $uav=="0" && $flight=="0")
            {
            	$errorp= "Select an Option";
            }
            elseif ($dateto!="" || $date!="" || $uav!="0" || $flight!="0")
            {
            	if ($flight=="0")
            	{
            		if ($uav=="0")
				                        ...
				                        echo "<p>Found ".$totalresults." results</p><br>";
				                         ...
				                         echo "<form name='let' action='' method='post'>";
							               ...
							               $links = array();
									         for( $i=1; $i<=$pages ; $i++)
									         {
									            $links[] = "<button class='button' value='$i' name='pag'>$i</button>"; 
									         }
									         echo implode(" - ", $links);
							                
							                echo "pagina $page de $pages";
							                echo "<input type='text' name='pages' value='$pages' class='hi'>";
							                echo "<input type='hidden' name='results' value=".$result4check.">";
							                echo "<input type='hidden' name='let2' value='$sqlsent4'>";
							                echo "</form>";
				                        ...
				                        echo "<p>Found ".$totalresults." results</p><br>";
				                         ...
				                         echo "<form name='let' action='' method='post'>";
							               ...
							               $links = array();
							                ...
							                echo "<input type='text' name='pages' value='$pages' class='hi'>";
							                echo "<input type='text' name='results' value='$result4check' class='hi'>";
							                echo "<input type='hidden' name='let2' value='$sqlsent4'>";
							                echo "</form>";
