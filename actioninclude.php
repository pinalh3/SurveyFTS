			...
			<div class="col-11 formcontainer" id="">
			    ...
			    <form class="incform" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post"> 
				        ...
				        <section class="row sepa"> 
				            <section class="col-2">
				                <label class="label1">Wich report it belongs to?</label>
    				        </section>
    				        <section class="col-10">
    				            
                    	                <?php    	
                    	                $sqlsent2="SELECT * FROM vreport;";
                    			        ...
                    			        $result2check = mysqli_num_rows($result2);
                    			    		...
                    			    		?>
                    			<input list="report" class="input1" name="reportid" type="text">    		
				        ...
				        <section class="row sepa"> 
				            <section class="col-2">
				                <label class="label1">Type of Action</label>
    				        </section>
    				        <section class="col-10">
    				            <select value="" name="actiontype" class="input1" id="acttype" required>
				        ...
				        <section class="row sepa"> 
				            <section class="col-2">
				                <label class="label1">Describe the Action</label>
    				        </section>
    				        <section class="col-10">
				        ...
				        <section class="row sepa"> 
				            <section class="col-2">
				                <label class="label1">Responsible for the action</label>
    				        </section>
    				        <section class="col-10">
    				            <select value="" name="resp" class="input1" id="resp" required>
	                    	        <option value="" class="tabd" ></option>
                    	                <?php    	
				        ...
				        <section class="row sepa"> 
				            <section class="col-2">
				                <label class="label1">Deadline</label>
    				        </section>
    				        <section class="col-10">
    				            <input type="date" class="input1" name="deadline" id="deadline" required>
    				            </textarea>
