		...
		<div class="col-10" id="form1">
			<div class="col-11 borsupe" id="flights">
				...
				<div class="topr right">
					<a href="crewinclude.php" class="include">Add New Crew +</a>
				</div>
			...
			<div class="col-11 formcontainer" id="">
			    ...
			    <?php
			    $sqlsent="SELECT * FROM crew;";
			    $result1=mysqli_query($conn, $sqlsent);
			    $result1check = mysqli_num_rows($result1);
			    
			    if ($result1check > 0)
			    {
			        echo "<tr class='tabheader'><th>Item</th><th>Dni</th><th>First Name</th><th>Last Name</th></tr>";
			        while ($row = mysqli_fetch_assoc($result1))
			        {
			           echo "<tr class='tabd'><td>".$row['crew_id']."</td><td>".$row['dni']."</td><td>".$row['first_name']."</td><td>".$row['first_surname']."</td><td><form action='crewfrontmod.php' method='post'><input type='text'name='view1' value='".$row['crew_id']."' class='hi'><input type='submit'name=submit value='view'></form></td></tr>"; 
			        }
			    }
			    else
			    {
